RegisterServerEvent('CTRPFW:DebugSomething')
AddEventHandler('CTRPFW:DebugSomething', function(resource, obj, depth)
...
CTRPFW.Debug = function(resource, obj, depth)
    TriggerEvent('CTRPFW:DebugSomething', resource, obj, depth)
end

CTRPFW.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

CTRPFW.ShowSuccess = function(resource, msg)
