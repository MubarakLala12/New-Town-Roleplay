...
AddEventHandler('police:client:spawnCone', function()
    CTRPFW.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
...
RegisterNetEvent('police:client:spawnboombox')
AddEventHandler('police:client:spawnboombox', function()
    local coords = GetEntityCoords(PlayerPedId())
    CTRPFW.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        ...
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("police:server:spawnObject", "boombox")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        CTRPFW.Functions.Notify("Canceled..", "error")
    end)
...
RegisterNetEvent('police:client:spawnboombox2')
AddEventHandler('police:client:spawnboombox2', function()
    local coords = GetEntityCoords(PlayerPedId())
    CTRPFW.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        ...
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("police:server:spawnObject", "boombox2")
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "anim@narcotics@trash", "drop_front", 1.0)
        CTRPFW.Functions.Notify("Canceled..", "error")
    end)
...
AddEventHandler('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        CTRPFW.Functions.Progressbar("remove_object", "Removing object..", 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
...
AddEventHandler('police:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < SpikeConfig.MaxSpikes then
        ...
        CTRPFW.Functions.Notify('There are no Spikestrips left..', 'error')
    end
end)
