    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('https://mdt/getWarrants', JSON.stringify({}));
        ...
        ForensicsSearch() {
            if (this.offender_search) {
                ...
                this.offender_results.query = this.offender_search;
                $.post('https://mdt/performForensicsSearch', JSON.stringify({
                    query: this.offender_search
                }));
        ...
        SentencePlayer() {
            ...
            $.post('https://mdt/sentencePlayer', JSON.stringify({
    ...
    if (document.readyState === "complete") {
        window.addEventListener('message', function(event) {
            if (event.data.type == "enable") {
                ...
                if (mdtApp.recent_searches.person.length > 10) {
                    Vue.delete(mdtApp.recent_searches.person, 10)
                }
                ...
                if (mdtApp.recent_searches.vehicle.length > 10) {
                    Vue.delete(mdtApp.recent_searches.vehicle, 10)
                }
