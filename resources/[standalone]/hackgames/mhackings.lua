...
AddEventHandler('mhackings:show', function()
    nuiMsg = {}
	nuiMsg.show = true
	SendNUIMessage(nuiMsg)
...
AddEventHandler('mhackings:hide', function()
    nuiMsg = {}
	nuiMsg.show = false
	SendNUIMessage(nuiMsg)
...
AddEventHandler('mhackings:start', function(solutionlength, duration, callback)
    mhackingsCallback = callback
	nuiMsg = {}
...
AddEventHandler('mhackings:setmessage', function(msg)
    nuiMsg = {}
...
RegisterNUICallback('callback', function(data, cb)
	mhackingsCallback(data.success, data.remainingtime)
    cb('ok')
end)