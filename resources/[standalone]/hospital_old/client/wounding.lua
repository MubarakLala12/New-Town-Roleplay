WeaponDamageList = {
	["WEAPON_UNARMED"] = "Fist wound of a punch",
	["WEAPON_ANIMAL"] = "Bite wound of an animal",
	["WEAPON_COUGAR"] = "Bite wound of an animal, cougar precisely",
	["WEAPON_KNIFE"] = "Stab wound from a knife",
    ["WEAPON_NIGHTSTICK"] = "Hit wounds from a stick",
    ["WEAPON_BREAD"] = "Dent in your head from bread!",
	["WEAPON_HAMMER"] = "Hit wounds from a stick or something",
	["WEAPON_BAT"] = "Hit wounds from a stick or something",
	["WEAPON_GOLFCLUB"] = "Hit wounds from a stick or something",
	["WEAPON_CROWBAR"] = "Hit wounds from a stick or something",
	["WEAPON_PISTOL"] = "Pistol bullets in the body",
	["WEAPON_COMBATPISTOL"] = "Pistol bullets in the body",
	["WEAPON_APPISTOL"] = "Automatic pistol bullets in the body",
	["WEAPON_PISTOL50"] = "50' Calibre Pistol bullets in the body",
	["WEAPON_MICROSMG"] = "Submachine gun bullets in the body",
	["WEAPON_SMG"] = "Submachine gun bullets in the body",
	["WEAPON_ASSAULTSMG"] = "Submachine gun bullets in the body",
	...
	["WEAPON_STUNGUN"] = "Tased in the body",
	...
	["WEAPON_FIREEXTINGUISHER"] = "Underpainted :)",
	...
	["WEAPON_EXPLOSION"] = "Many burns (of explosive)",
	["WEAPON_FALL"] = "Broken bones",
	["WEAPON_EXHAUSTION"] = "Died of Exhaustion",
	["WEAPON_HIT_BY_WATER_CANNON"] = "Water Cannon Pelts",
	["WEAPON_RAMMED_BY_CAR"] = "Vehicle accident",
	["WEAPON_RUN_OVER_BY_CAR"] = "Ran over by a vehicle",
            ...
            if bleedTickTimer >= Config.BleedTickRate and not isInHospitalBed then
                if not isDead and not InLaststand then
                    if isBleeding > 0 then
                        ...
                        TriggerServerEvent("evidence:server:CreateBloodDrop", CTRPFW.Functions.GetPlayerData().citizenid, CTRPFW.Functions.GetPlayerData().metadata["bloodtype"], coords)
...
AddEventHandler('hospital:client:UseBandage', function()
    ...
    CTRPFW.Functions.Progressbar("use_bandage", "Put on a bandage..", 4000, false, true, {
...
RegisterNetEvent('hospital:client:UseFirstAiditem')
AddEventHandler('hospital:client:UseFirstAiditem', function()
    CTRPFW.Functions.Progressbar("use_bandage", "Wrapping up wounds..", 4000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        SetEntityHealth(GetPlayerPed(-1), GetEntityHealth(GetPlayerPed(-1)) + 55)
        if math.random(1, 100) < 50 then
            RemoveBleed(1)
        end
        if math.random(1, 100) < 7 then
...
AddEventHandler('hospital:client:UsePainkillers', function()
    ...
    TriggerServerEvent("CTRPFW:Server:RemoveItem", "painkillers", 1)
    TriggerEvent("inventory:client:ItemBox", CTRPFW.Shared.Items["painkillers"], "remove")

    CTRPFW.Functions.Progressbar("use_bandage", "Take painkillers", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler('hospital:client:UseIfak', function()
    ...
    TriggerServerEvent("CTRPFW:Server:RemoveItem", "ifak", 1)
    TriggerEvent("inventory:client:ItemBox", CTRPFW.Shared.Items["ifak"], "remove")
    
    CTRPFW.Functions.Progressbar("use_ifak", "ifak on..", 4000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
