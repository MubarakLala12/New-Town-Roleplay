...
--------------------------
roleList = {
"Weapon Perms",  -- Weapon Permission Granted
}
...
RegisterServerEvent('WeaponPerm:notification')
AddEventHandler('WeaponPerm:notification', function()
    local src = source
	TriggerClientEvent('chatMessage', src, "SYSTEM", "error", "You are not allowed use this Weapon")
    -- TriggerClientEvent('chat:addMessage', src, {
    --     template = '<div class="error">SYSTEM: {0}</div>',
    --     args = { 'You are not allowed use this Weapon' }
    -- })
end)