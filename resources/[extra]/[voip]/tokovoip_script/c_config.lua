TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "In-Game Server",
		TSPassword = "123456789", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "ts.ctrp.in", -- TeamSpeak server address to be displayed on blocking screen
		...
		localName = "Player", -- If set, this name will be used as the user's teamspeak display name
