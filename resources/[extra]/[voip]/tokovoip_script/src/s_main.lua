	...
	if (not channels[channelId]) then
		if type == "radio" then
			if SplitStr(channelId, ".")[2] ~= nil and SplitStr(channelId, ".")[2] ~= "" then 
				channels[channelId] = {id = channelId, name = "Frequency " .. channelId, subscribers = {}};
			else
				channels[channelId] = {id = channelId, name = "Frequency " .. channelId .. ".00 MHz", subscribers = {}};
			end
		else
			channels[channelId] = {id = channelId, name = "In call, ID: " .. channelId, subscribers = {}};
		end
	end
