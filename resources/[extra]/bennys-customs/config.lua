bennyLocation1 = vector3(-323.17, -133.83, 38.28)
bennyLocation2 = vector3(-315.87, -113.26, 38.28)
bennyLocation3 = vector3(-352.72, -90.22, 39.03)
maxVehiclePerformanceUpgrades = 0 -- Set to 0 to have all the upgrades
-- vehicleBaseRepairCost = 1000
-- vehicleRepairCostMultiplier = 2

-- Location Configs

-- bennyLocations = {
--     vector4(-323.17, -133.83, 38.28, 70.12),
--     vector4(-315.87, -113.26, 38.28, 69.22),
--     vector4(-352.72, -90.22, 39.03, 69.95)
-- }
...
vehicleCustomisationPrices = {
    ...
    turbo = {price = 15000},
    wheels = {price = 600},
    customwheels = {price = 800},
    wheelsmoke = {price = 2000},
    windowtint = {price = 800},
    neonside = {price = 1000},
    neoncolours = {price = 1500},
    headlights = {price = 1000},
    xenoncolours = {price = 1000},
    oldlivery = {price = 1000},
