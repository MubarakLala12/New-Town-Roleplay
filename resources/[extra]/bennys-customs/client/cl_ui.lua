...
function InitiateMenus(isMotorcycle, vehicleHealth)
    ...
    --     TriggerServerEvent("bennys-customs:updateRepairCost", repairCost)
    --     createMenu("repairMenu", "Welcome to Los Santos Coustom", "Repair Vehicle")
    --     populateMenu("repairMenu", -1, "Repair", "$" .. repairCost)
    --     finishPopulatingMenu("repairMenu")
    -- end

    --#[Main Menu]#--
    createMenu("mainMenu", "Welcome to Los Santos Coustom", "Choose a Category")
