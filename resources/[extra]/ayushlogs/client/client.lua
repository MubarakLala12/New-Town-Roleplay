WeaponNames = {
	...
	[tostring(GetHashKey('WEAPON_M4A4'))] = 'WEAPON M4A4',
	[tostring(GetHashKey('WEAPON_NSR'))] = 'WEAPON NSR',
	[tostring(GetHashKey('WEAPON_P90'))] = 'WEAPON P90'
}
...
function IsSub(Weapon)
	local Weapons = {'WEAPON_MICROSMG', 'WEAPON_SMG', 'WEAPON_P90'}
	for i, CurrentWeapon in ipairs(Weapons) do
		if GetHashKey(CurrentWeapon) == Weapon then
			return true
		end
...
function IsRifle(Weapon)
	local Weapons = {'WEAPON_CARBINERIFLE', 'WEAPON_MUSKET', 'WEAPON_ADVANCEDRIFLE', 'WEAPON_ASSAULTRIFLE', 'WEAPON_SPECIALCARBINE', 'WEAPON_COMPACTRIFLE', 'WEAPON_BULLPUPRIFLE', 'WEAPON_M4A4', 'WEAPON_NSR'}
	for i, CurrentWeapon in ipairs(Weapons) do
		if GetHashKey(CurrentWeapon) == Weapon then
			return true
		end
...
function ShowDebug(text)
	...
	AddTextComponentSubstringPlayerName("~b~CTRP_LOGS Debug:~s~\n"..text)
