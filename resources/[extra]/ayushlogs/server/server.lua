...
exports('discord', function(message, id, id2, color, channel)
	...
	if message == nil then print("^1Error: CTRP_LOGS Export. Invalid message.^0") return end
	if id == nil or id == "PLAYER_ID" or not tonumber(id) then print("^1Error: CTRP_LOGS Export. Invalid player id.^0") return end
	if id == nil or id2 == "PLAYER_2_ID" or not tonumber(id2) then print("^1Error: CTRP_LOGS Export. Invalid second player id.^0") return end
	if color == nil then print("^1Error: CTRP_LOGS Export. Invalid color.^0") return end
	if channel == nil or channel == "" then print("^1Error: CTRP_LOGS Export. Invalid channel.^0") return end
