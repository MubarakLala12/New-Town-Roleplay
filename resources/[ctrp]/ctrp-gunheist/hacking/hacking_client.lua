...
local gamePassword = "VIRUSOPP" --You could make a table with passwords and assign them as passwords in random order.
...
function StartHacking()
	...
	TriggerEvent('ctrp-hud:displayHud', false)
...
Citizen.CreateThread(function()
	while true do
		if HasScaleformMovieLoaded(scaleform) then
			...
			if hacking then
				hacking = false
				TriggerEvent('ctrp-hud:displayHud', true)
				SetScaleformMovieAsNoLongerNeeded(scaleform)
			end
