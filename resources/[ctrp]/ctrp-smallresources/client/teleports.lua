...
Teleports.Locations = {
    [1] = {
        [1] = {x = 2939.05, y = 4624.26, z = 48.72, h = 55.91, r = 1.0},
        [2] = {x = 1066.65, y = -3183.47, z = -39.17, h = 269.99, r = 1.0},
    },
    [2] = {
        [3] = {x = 2287.4148, y = 1709.5098, z = 68.0405, h = 352.7850, r = 1.0},
        [4] = {x = 207.21,y = -1018.33,z = -99.0, h = 269.99, r = 1.0},
    }
}
            ...
            for k, v in pairs(Teleports.Locations[loc]) do
                ...
                if dist < 2 then
                    ...
                    if dist < 1 then
                        ...
                        if IsControlJustReleased(0, 51) then
                            if k == 3 then
                                SetEntityCoords(ped, Teleports.Locations[loc][4].x, Teleports.Locations[loc][4].y, Teleports.Locations[loc][4].z)
                            elseif k == 4 then
                                SetEntityCoords(ped, Teleports.Locations[loc][3].x, Teleports.Locations[loc][3].y, Teleports.Locations[loc][3].z)
                            end
                            ResetTeleport()
                        end
                    end
