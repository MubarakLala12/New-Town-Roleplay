...
Citizen.CreateThread(function()
    while CTRPFW == nil do
        ...
        CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:getConfig', function(value)
            Config = value
        end)
        Citizen.Wait(200)
    end
...
RegisterNetEvent('ctrp-phone_new:client:RaceNotify')
AddEventHandler('ctrp-phone_new:client:RaceNotify', function(message)
...
RegisterNetEvent('ctrp-phone_new:client:AddRecentCall')
AddEventHandler('ctrp-phone_new:client:AddRecentCall', function(data, time, type)
    ...
    TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', "phone")
...
RegisterNUICallback('ClearRecentAlerts', function(data, cb)
    TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', "phone", 0)
...
RegisterNUICallback('SetBackground', function(data)
    ...
    TriggerServerEvent('ctrp-phone_new:server:SaveMetaData', PhoneData.MetaData)
end)
        ...
        if IsControlJustPressed(0, Config.OpenPhone) then
            if not PhoneData.isOpen then
                ...
                if not IsHandcuffed then
                    ...
                    CTRPFW.Functions.Notify("Action currently not possible..", "error")
                end
            end
        end
        Citizen.Wait(3)
...
Citizen.CreateThread(function()
    while true do
        ...
        if isLoggedIn then
            CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetPhoneData', function(pData)   
...
function LoadPhone()
    ...
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetPhoneData', function(pData)
        ...
        PhoneData.PlayerData = CTRPFW.Functions.GetPlayerData()
...
RegisterNUICallback('HasPhone', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:HasPhone', function(HasPhone)
        cb(HasPhone)
    end)
end)
...
function OpenPhone()
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:HasPhone', function(HasPhone)
        if HasPhone then
            ...
            CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetGarageVehicles', function(vehicles)
                PhoneData.GarageVehicles = vehicles
            end)
        else
            CTRPFW.Functions.Notify("You don't have a Phone", "error")
        end
    end)
end
...
RegisterNUICallback('RemoveMail', function(data, cb)
    ...
    TriggerServerEvent('ctrp-phone_new:server:RemoveMail', MailId)
    cb('ok')
end)

RegisterNetEvent('ctrp-phone_new:client:UpdateMails')
AddEventHandler('ctrp-phone_new:client:UpdateMails', function(NewMails)
    SendNUIMessage({
        action = "UpdateMails",
        Mails = NewMails
    })
...
RegisterNUICallback('AcceptMailButton', function(data)
    ...
    TriggerServerEvent('ctrp-phone_new:server:ClearButtonData', data.mailId)
end)
...
RegisterNUICallback('AddNewContact', function(data, cb)
    ...
    TriggerServerEvent('ctrp-phone_new:server:AddNewContact', data.ContactName, data.ContactNumber, data.ContactIban)
end)
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    if PhoneData.Chats[NumberKey] ~= nil then
        ...
        if PhoneData.Chats[NumberKey].messages[ChatKey] ~= nil then
            ...
            TriggerServerEvent('ctrp-phone_new:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, false)
            ...
            TriggerServerEvent('ctrp-phone_new:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, true)
            NumberKey = GetKeyByNumber(ChatNumber)
            ReorganizeChats(NumberKey)
        end
    else
    ...
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
RegisterNetEvent('ctrp-phone_new:client:UpdateMessages')
AddEventHandler('ctrp-phone_new:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
    ...
    if New then
        ...
        if PhoneData.isOpen then
            ...
            Wait(100)
            CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetContactPictures', function(Chats)
                SendNUIMessage({
                    action = "UpdateChat",
            ...
            TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', "whatsapp")
        end
    else
...
RegisterNetEvent("ctrp-phone_new-new:client:BankNotify")
AddEventHandler("ctrp-phone_new-new:client:BankNotify", function(text)
    TriggerServerEvent("InteractSound_SV:PlayOnSource", "vtexts", 0.4)
    SendNUIMessage({
        action = "Notification",
        NotifyData = {
...
RegisterNetEvent('ctrp-phone_new:client:NewMailNotify')
AddEventHandler('ctrp-phone_new:client:NewMailNotify', function(MailData)
    if PhoneData.isOpen then
        TriggerServerEvent("InteractSound_SV:PlayOnSource", "vtexts", 0.4)
        SendNUIMessage({
            action = "PhoneNotification",
            PhoneNotify = {
                title = "Mail",
                text = "You have received a new Mail fromn "..MailData.sender,
    ...
    TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', "mail")
end)

RegisterNUICallback('PostAdvert', function(data)
    TriggerServerEvent('ctrp-phone_new:server:AddAdvert', data.message)
end)

RegisterNetEvent('ctrp-phone_new:client:UpdateAdverts')
AddEventHandler('ctrp-phone_new:client:UpdateAdverts', function(Adverts, LastAd)
...
RegisterNUICallback('ClearAlerts', function(data, cb)
    ...
    if PhoneData.Chats[ChatKey].Unread ~= nil then
        ...
        TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', "whatsapp", newAlerts)
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:DeclineInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('EditContact', function(data, cb)
    ...
    Citizen.Wait(100)
    cb(PhoneData.Contacts)
    TriggerServerEvent('ctrp-phone_new:server:EditContact', NewName, NewNumber, NewIban, OldName, OldNumber, OldIban)
end)
...
RegisterNetEvent('ctrp-phone_new:client:UpdateHashtags')
AddEventHandler('ctrp-phone_new:client:UpdateHashtags', function(Handle, msgData)
...
RegisterNUICallback('SendNewTweet', function(data, cb)
    ...
    for i = 2, #Hashtag, 1 do
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            TriggerServerEvent('ctrp-phone_new:server:UpdateHashtags', Handle, TweetMessage)
        end
    end
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            if (Firstname ~= nil and Firstname ~= "") and (Lastname ~= nil and Lastname ~= "") then
                if Firstname ~= PhoneData.PlayerData.charinfo.firstname and Lastname ~= PhoneData.PlayerData.charinfo.lastname then
                    TriggerServerEvent('ctrp-phone_new:server:MentionedPlayer', Firstname, Lastname, TweetMessage)
                else
    ...
    TriggerServerEvent('ctrp-phone_new:server:UpdateTweets', PhoneData.Tweets, TweetMessage)
end)

RegisterNetEvent('ctrp-phone_new:client:TransferMoney')
AddEventHandler('ctrp-phone_new:client:TransferMoney', function(amount, newmoney)
    PhoneData.PlayerData.money.bank = newmoney
    if PhoneData.isOpen then
        TriggerServerEvent("InteractSound_SV:PlayOnSource", "vtexts", 0.4)
        SendNUIMessage({ action = "PhoneNotification", PhoneNotify = { title = "CTRPBank", text = "There is &dollar;"..amount.." credited!", icon = "fas fa-university", color = "#8c7ae6", }, })
        SendNUIMessage({ action = "UpdateBank", NewBalance = PhoneData.PlayerData.money.bank })
    else
        TriggerServerEvent("InteractSound_SV:PlayOnSource", "vtexts", 0.4)
        SendNUIMessage({ action = "Notification", NotifyData = { title = "CTRPBank", content = "There is &dollar;"..amount.." credited!", icon = "fas fa-university", timeout = 2500, color = nil, }, })
    end
end)


RegisterNetEvent('ctrp-phone_new:client:UpdateTweets')
AddEventHandler('ctrp-phone_new:client:UpdateTweets', function(src, Tweets, NewTweetData)
...
RegisterNetEvent('ctrp-phone_new:client:GetMentioned')
AddEventHandler('ctrp-phone_new:client:GetMentioned', function(TweetMessage, AppAlerts)
...
RegisterNUICallback('ClearMentions', function()
    ...
    TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', "twitter", 0)
    SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
end)
...
while takePhoto do
    ...
    exports['screenshot-basic']:requestScreenshotUpload('https://discordapp.com/api/webhooks/879019824355889204/yhqskGSSGM2fMzLjv4B_Q-U-ZhKUSAWLjrpCggIiO-lTkROEpE1WCLxv3JROF4Ps4X3_', 'files[]', function(data2)
        DestroyMobilePhone()
...
RegisterNUICallback('ClearGeneralAlerts', function(data)
    SetTimeout(400, function()
        ...
        TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', data.app, 0)
        SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
    end)
end)
...
RegisterNUICallback('TransferMoney', function(data, cb)
    ...
    if tonumber(PhoneData.PlayerData.money.bank) >= data.amount then
        local amaountata = CTRPFW.Functions.GetPlayerData().money["bank"] - data.amount
        --local amaountata = PhoneData.PlayerData.money.bank - data.amount
        TriggerServerEvent('ctrp-phone_new:server:TransferMoney', data.iban, data.amount)
        local cbdata = {
            CanTransfer = true,
...
RegisterNUICallback('CanTransferMoney', function(data, cb)
    ...
    if (PlayerData.money.bank - amount) >= 0 then
        CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:CanTransferMoney', function(Transferd)
            if Transferd then
...
RegisterNUICallback('CallContact', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetCallState', function(CanCall, IsOnline)
        local status = { 
            CanCall = CanCall, 
            IsOnline = IsOnline,
...
CallContact = function(CallData, AnonymousCall)
    ...
    TriggerServerEvent('ctrp-phone_new:server:CallContact', PhoneData.CallData.TargetData, PhoneData.CallData.CallId, AnonymousCall)
    TriggerServerEvent('ctrp-phone_new:server:SetCallState', true)
...
CancelCall = function()
    TriggerServerEvent('ctrp-phone_new:server:CancelCall', PhoneData.CallData)
    ...
    TriggerServerEvent('ctrp-phone_new:server:SetCallState', false)
...
RegisterNetEvent('ctrp-phone_new:client:CancelCall')
AddEventHandler('ctrp-phone_new:client:CancelCall', function()
    if PhoneData.CallData.CallType == "ongoing" then
        SendNUIMessage({
...
RegisterNetEvent('ctrp-phone_new:client:GetCalled')
AddEventHandler('ctrp-phone_new:client:GetCalled', function(CallerNumber, CallId, AnonymousCall)
    local RepeatCount = 0
    local CallData = {
        number = CallerNumber,
        ...
        if not PhoneData.CallData.AnsweredCall then
            if RepeatCount + 1 ~= Config.CallRepeats + 1 then
                if PhoneData.CallData.InCall then
                    ...
                    TriggerServerEvent('ctrp-phone_new:server:AddRecentCall', "missed", CallData)
                    break
                end
                Citizen.Wait(Config.RepeatTimeout)
            else
...
RegisterNetEvent("ctrp-phone_new:client:command_ac")
AddEventHandler("ctrp-phone_new:client:command_ac",function()
    AnswerCall()
end)
RegisterNetEvent("ctrp-phone_new:client:command_cc")
AddEventHandler("ctrp-phone_new:client:command_cc",function()
    CancelCall()
end)
...
function AnswerCall()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        ...
        TriggerServerEvent('ctrp-phone_new:server:AnswerCall', PhoneData.CallData)
...
RegisterNetEvent('ctrp-phone_new:client:AnswerCall')
AddEventHandler('ctrp-phone_new:client:AnswerCall', function()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        PhoneData.CallData.CallType = "ongoing"
        PhoneData.CallData.AnsweredCall = true
        PhoneData.CallData.CallTime = 0
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:FetchResult', function(result)
        cb(result)
    end, data.input)
end)

RegisterNUICallback('FetchVehicleResults', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetVehicleSearchResults', function(result)
        if result ~= nil then 
            for k, v in pairs(result) do
                CTRPFW.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    ...
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:ScanPlate', function(result)
        CTRPFW.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
            result.isFlagged = flagged
            local vehicleInfo = CTRPFW.Shared.Vehicles[CTRPFW.Shared.VehicleModels[model]["model"]] ~= nil and CTRPFW.Shared.Vehicles[CTRPFW.Shared.VehicleModels[model]["model"]] or {["brand"] = "Unknown brand..", ["name"] = ""}
...
RegisterNetEvent('ctrp-phone:client:addPoliceAlert')
AddEventHandler('ctrp-phone:client:addPoliceAlert', function(alertData)
    PlayerJob = CTRPFW.Functions.GetPlayerData().job
    if PlayerJob.name == 'police' and PlayerJob.onduty then
        print('Phone: New Police Alert')
...
RegisterNUICallback('SetAlertWaypoint', function(data)
    ...
    CTRPFW.Functions.Notify('GPS Location set: '..data.alert.title)
...
RegisterNetEvent('ctrp-phone_new:client:GiveContactDetails')
AddEventHandler('ctrp-phone_new:client:GiveContactDetails', function()
    local ped = GetPlayerPed(-1)

    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local PlayerId = GetPlayerServerId(player)
        TriggerServerEvent('ctrp-phone_new:server:GiveContactDetails', PlayerId)
    else
...
-- Citizen.CreateThread(function()
--     Wait(1000)
--     TriggerServerEvent('ctrp-phone_new:server:GiveContactDetails', 1)
-- end)
...
RegisterNUICallback('DeleteContact', function(data, cb)
    ...
    TriggerServerEvent('ctrp-phone_new:server:RemoveContact', Name, Number)
end)

RegisterNetEvent('ctrp-phone_new:client:AddNewSuggestion')
AddEventHandler('ctrp-phone_new:client:AddNewSuggestion', function(SuggestionData)
    ...
    Config.PhoneApplications["phone"].Alerts = Config.PhoneApplications["phone"].Alerts + 1
    TriggerServerEvent('ctrp-phone:server:SetPhoneAlerts', "phone", Config.PhoneApplications["phone"].Alerts)
end)

RegisterNUICallback('GetCryptoData', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-crypto:server:GetCryptoData', function(CryptoData)
        cb(CryptoData)
    end, data.crypto)
end)

RegisterNUICallback('BuyCrypto', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-crypto:server:BuyCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('SellCrypto', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-crypto:server:SellCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('TransferCrypto', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-crypto:server:TransferCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNetEvent('ctrp-phone_new:client:RemoveBankMoney')
AddEventHandler('ctrp-phone_new:client:RemoveBankMoney', function(amount)
    if PhoneData.isOpen then
        TriggerServerEvent("InteractSound_SV:PlayOnSource", "vtexts", 0.4)
        SendNUIMessage({
            action = "PhoneNotification",
            PhoneNotify = {
                title = "Bank",
                text = "There is $"..amount.." deducted from your bank!", 
                icon = "fas fa-university", 
                color = "#ff002f",
                timeout = 3500,
            },
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Bank",
                content = "There is $"..amount.." deducted from your bank!", 
                icon = "fas fa-university",
                timeout = 3500, 
                color = "#ff002f",
            },
...
RegisterNetEvent('ctrp-phone_new:client:AddTransaction')
AddEventHandler('ctrp-phone_new:client:AddTransaction', function(SenderData, TransactionData, Message, Title)
    local Data = {
    ...
    TriggerServerEvent('ctrp-phone_new:server:AddTransaction', Data)
end)
...
RegisterNUICallback('GetAvailableRaces', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('JoinRace', function(data)
    TriggerServerEvent('ctrp-lapraces:server:JoinRace', data.RaceData)
end)

RegisterNUICallback('LeaveRace', function(data)
    TriggerServerEvent('ctrp-lapraces:server:LeaveRace', data.RaceData)
end)

RegisterNUICallback('StartRace', function(data)
    TriggerServerEvent('ctrp-lapraces:server:StartRace', data.RaceData.RaceId)
end)

RegisterNetEvent('ctrp-phone_new:client:UpdateLapraces')
AddEventHandler('ctrp-phone_new:client:UpdateLapraces', function()
    SendNUIMessage({
...
RegisterNUICallback("GetCurrentDrivers", function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetCurrentDrivers', function(drivers)
        cb(drivers)
    end)
end)

RegisterNUICallback('GetRaces', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('SetupRace', function(data, cb)
    TriggerServerEvent('ctrp-lapraces:server:SetupRace', data.RaceId, tonumber(data.AmountOfLaps))
end)

RegisterNUICallback('HasCreatedRace', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)

RegisterNUICallback('IsInRace', function(data, cb)
    local InRace = exports['ctrp-lapraces']:IsInRace()
    cb(InRace)
end)

RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
            IsAuthorized = IsAuthorized,
            IsBusy = exports['ctrp-lapraces']:IsInEditor(),
...
RegisterNUICallback('StartTrackEditor', function(data, cb)
    TriggerServerEvent('ctrp-lapraces:server:CreateLapRace', data.TrackName)
end)

RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:GetRacingData', function(RaceData)
        local ped = GetPlayerPed(-1)
        ...
        if dist <= 115.0 then
            if data.Joined then
                TriggerEvent('ctrp-lapraces:client:WaitingDistanceCheck')
            end
            cb(true)
        else
            CTRPFW.Functions.Notify('You are too far from the race. Your navigation is set to the race.', 'error', 5000)
...
RegisterNUICallback('IsBusyCheck', function(data, cb)
    if data.check == "editor" then
        cb(exports['ctrp-lapraces']:IsInEditor())
    else
        cb(exports['ctrp-lapraces']:IsInRace())
    end
end)

RegisterNUICallback('CanRaceSetup', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-lapraces:server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)

RegisterNUICallback('GetPlayerHouses', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetPlayerHouses', function(Houses)
        cb(json.encode(Houses))
    end)
end)

RegisterNUICallback('GetPlayerKeys', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetHouseKeys', function(Keys)
        cb(Keys)
    end)
end)
...
RegisterNUICallback('SetHouseLocation', function(data, cb)
    ...
    CTRPFW.Functions.Notify("Your GPS is set to " .. data.HouseData.HouseData.adress .. "!", "success")
end)

RegisterNUICallback('RemoveKeyholder', function(data)
    TriggerServerEvent('ctrp-houses:server:removeHouseKey', data.HouseData.name, {
...
RegisterNUICallback('TransferCid', function(data, cb)
    ...
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:TransferCid', function(CanTransfer)
        cb(CanTransfer)
    end, TransferedCid, data.HouseData)
end)

RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('SetGPSLocation', function(data, cb)
    ...
    CTRPFW.Functions.Notify('GPS is set!', 'success')
end)
...
RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    CTRPFW.Functions.TriggerCallback('ctrp-phone_new:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)
...
RegisterNUICallback('InstallApplication', function(data, cb)
    ...
    if NewSlot <= Config.MaxSlots then
        TriggerServerEvent('ctrp-phone_new:server:InstallApplication', {
            app = data.app,
        })
        cb({
            app = data.app,
...
RegisterNUICallback('RemoveApplication', function(data, cb)
    TriggerServerEvent('ctrp-phone_new:server:RemoveInstallation', data.app)
end)

RegisterNetEvent('ctrp-phone_new:RefreshPhone')
AddEventHandler('ctrp-phone_new:RefreshPhone', function()
    LoadPhone()
    SetTimeout(250, function()
        SendNUIMessage({
...
RegisterNUICallback('GetTruckerData', function(data, cb)
    local TruckerMeta = CTRPFW.Functions.GetPlayerData().metadata["jobrep"]["trucker"]
    local TierData = exports['ctrp-trucker']:GetTier(TruckerMeta)
    cb(TierData)
end)
...
RegisterNetEvent('virus:Client:phonebandh')
AddEventHandler('virus:Client:phonebandh', function()
    SendNUIMessage({
		command = "closebycommand"})
end)
