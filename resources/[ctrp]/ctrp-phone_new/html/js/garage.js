...
SetupDetails = function(data) {
    ...
    $(".vehicle-date").find(".vehicle-answer").html(data.date);
    ...
    $(".vehicle-total").find(".vehicle-answer").html(Math.ceil(data.buy_price) +" $");
    $(".vehicle-finance").find(".vehicle-answer").html(Math.ceil(data.finance) +" $");
    $(".vehicle-fdate").find(".vehicle-answer").html(data.fdate);
    $(".vehicle-repayam").find(".vehicle-answer").html(Math.ceil(data.repayam) +" $");
    $(".vehicle-repay").find(".vehicle-answer").html(Math.ceil(data.repaytime) +" hrs");
