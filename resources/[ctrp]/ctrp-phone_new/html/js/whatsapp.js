...
$(document).on('click', '.whatsapp-chat', function(e){
    ...
    $.post('https://ctrp-phone_new/ClearAlerts', JSON.stringify({
...
const monthNames = ["Janurary", "February", "March", "April", "March", "June", "July", "August", "September", "October", "November", "December"];
...
$(document).on('click', '#whatsapp-openedchat-send', function(e){
    ...
    if (Message !== null && Message !== undefined && Message !== "") {
        $.post('https://ctrp-phone_new/SendMessage', JSON.stringify({
        ...
        RS.Phone.Notifications.Add("fab fa-whatsapp", "Whatsapp", "You cannot send an empty message!", "#25D366", 1750);
    }
});
...
//         if (OpenedChatPicture == null) {
//             $.post('https://ctrp-phone_new/GetProfilePicture', JSON.stringify({
...
//                     MessageElement = '<div class="whatsapp-openedchat-message whatsapp-openedchat-message-'+Sender+' whatsapp-shared-location" data-x="'+message.data.x+'" data-y="'+message.data.y+'" data-toggle="tooltip" data-placement="bottom" title="'+ChatDate+'"><span style="font-size: 1.2vh;"><i class="fas fa-thumbtack" style="font-size: 1vh;"></i> Location</span><div class="whatsapp-openedchat-message-time">'+message.time+'</div></div><div class="clearfix"></div>'
//                 }
...
$(document).on('click', '.whatsapp-shared-location', function(e){
    ...
    $.post('https://ctrp-phone_new/SharedLocation', JSON.stringify({
