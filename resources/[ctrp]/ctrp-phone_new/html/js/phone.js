...
$(document).on('click', '.phone-app-footer-button', function(e){
    ...
    if (PressedFooterTab !== CurrentFooterTab) {
        ...
        if (PressedFooterTab == "recent") {
            $.post('https://ctrp-phone_new/ClearRecentAlerts');
...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    if (RecentData.name == "Anonymous") {
        RS.Phone.Notifications.Add("fas fa-phone", "Phone", "You cannot call back an Anonymous number!");
    } else {
                    ...
                    if (status.CanCall) {
                        if (!status.InCall) {
                            if (RS.Phone.Data.AnonymousCall) {
                                RS.Phone.Notifications.Add("fas fa-phone", "Phone", "You have initiated an Anonymouse call!");
                            }
                            ...
                            RS.Phone.Notifications.Add("fas fa-phone", "Phone", "You are already in a conversation!");
                        }
                    } else {
                        RS.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is In conversation!");
                    }
                } else {
                    RS.Phone.Notifications.Add("fas fa-phone", "Phone", "This person cannot be reached!");
                }
            } else {
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== RS.Phone.Data.PlayerData.charinfo.phone) {
        ...
        setTimeout(function(){
            ...
            $.post('https://ctrp-phone_new/GetWhatsappChat', JSON.stringify({phone: ContactData.number}), function(chat){
        ...
        RS.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "You can't text yourself, sad fuck..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://ctrp-phone_new/EditContact', JSON.stringify({
        ...
        RS.Phone.Notifications.Add("fas fa-exclamation-circle", "Contact Edit", "Fill out all fields!");
    }
});
...
$(document).on('click', '#edit-contact-delete', function(e){
    ...
    $.post('https://ctrp-phone_new/DeleteContact', JSON.stringify({
        CurrentContactName: ContactName,
        CurrentContactNumber: ContactNumber,
        CurrentContactIban: ContactIban,
    }), function(PhoneContacts){
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://ctrp-phone_new/AddNewContact', JSON.stringify({
        ...
        if (SelectedSuggestion !== null) {
            $.post('https://ctrp-phone_new/RemoveSuggestion', JSON.stringify({
        ...
        RS.Phone.Notifications.Add("fas fa-plus-square", "Add Contact", "Fill out all fields!");
    }
});
...
$(document).on('click', '#outgoing-cancel', function(e){
    ...
    $.post('https://ctrp-phone_new/CancelOutgoingCall');
});

$(document).on('click', '#incoming-deny', function(e){
    e.preventDefault();

    $.post('https://ctrp-phone_new/DenyIncomingCall');
});

$(document).on('click', '#ongoing-cancel', function(e){
    e.preventDefault();
    
    $.post('https://ctrp-phone_new/CancelOngoingCall');
});
...
$(document).on('click', '#incoming-answer', function(e){
    ...
    $.post('https://ctrp-phone_new/AnswerCall');
});
