...
$(document).on('click', '#accept-mail', function(e){
    ...
    $.post('https://ctrp-phone_new/AcceptMailButton', JSON.stringify({
...
$(document).on('click', '#remove-mail', function(e){
    e.preventDefault();
    var MailData = $("#"+OpenedMail).data('MailData');
    $.post('https://ctrp-phone_new/RemoveMail', JSON.stringify({
        mailId: MailData.mailid
    }));
    $(".mail-home").animate({
        left: 0+"vh"
...
RS.Phone.Functions.SetupMails = function(Mails) {
    ...
    if (Mails !== null && Mails !== undefined) {
        if (Mails.length > 0) {
            ...
            $(".mail-list").html('<p class="nomails">You dont have any emails yet ..</p>');
        }

    }
}

var MonthFormatting = ["January", "Februrary", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
