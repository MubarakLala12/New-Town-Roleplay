...
files {
	...
	'stream/fury_apt_motel/fury_apt_shell.ytyp',

	
	'stream/fury_shell01/fury_shell01.ytyp',
	'stream/fury_shell02/fury_shell02.ytyp',
	'stream/fury_shell03/fury_shell03.ytyp',
	'stream/fury_shell05/fury_shell05.ytyp',

	'stream/warehouse_shell/warehouse_shell.ytyp',
	'stream/pinkcage/gabz_pinkcage.ytyp',
	'stream/fury_motel/motel_shell.ytyp',
}
...
data_file 'DLC_ITYP_REQUEST' 'stream/fury_apt_motel/fury_apt_shell.ytyp'

data_file 'DLC_ITYP_REQUEST' 'stream/fury_shell01/fury_shell01.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/fury_shell02/fury_shell02.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/fury_shell03/fury_shell03.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/fury_shell05/fury_shell05.ytyp'
...
data_file 'DLC_ITYP_REQUEST' 'stream/fury_motel/motel_shell.ytyp'
