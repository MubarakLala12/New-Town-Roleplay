...
var MainDigits = 5;
var RotationTime = 30000; // time ms
var RotationDegree = 3180*(RotationTime/30000);
...
$(document).ready(function() {
    ...
    window.addEventListener('click',function() {
        ...
        if (distance < HitDistance) {
            ...
            MainDigits--;
            $.post("http://ctrp-bankrobbery/thermiteclick");
...
Thermite.Failed = function() {
    if (active) $.post("http://ctrp-bankrobbery/thermitefailed");
    active = false;
    Thermite.Close();
}

Thermite.Success = function() {
    if (active) $.post("http://ctrp-bankrobbery/thermitesuccess");
    active = false;
    Thermite.Close();
}
...
Thermite.Close = function() {
    ...
    $.post('http://ctrp-bankrobbery/closethermite');
}