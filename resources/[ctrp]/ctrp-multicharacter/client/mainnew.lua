...
Config = {
  PedCoords = {x = -1057.31, y = -2763.49, z = -4.07, h = 243.79 , r = 1.0},
  HiddenCoords = {x = -1034.68, y = -2732.54, z = -20.17, h = 148.15, r = 1.0},
  CamCoords = {x = -1054.54, y = -2764.89, z = -3.72, h = 59.00 , r = 1.0},
}
...
AddEventHandler('ctrp-multicharacter:client:chooseChar', function()
    ...
    DoScreenFadeOut(10)
    Citizen.Wait(1000)
    local interior = GetInteriorAtCoords(-1055.56, -2764.5, -3.72, 59.00)
...
function skyCam(bool)
    ...
    if bool then
        ...
        cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -1055.56, -2764.5, -3.72, 0.0 ,0.0, 57.00, 63.00, false, 0)
