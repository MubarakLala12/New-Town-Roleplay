...
Config.useCoD = true -- change this if you want to have a global cooldown or not
Config.codTime = 30 * (60 * 2000) -- global cooldown in ms. Set to 20 minutes by default - (https://www.timecalculator.net/minutes-to-milliseconds)
