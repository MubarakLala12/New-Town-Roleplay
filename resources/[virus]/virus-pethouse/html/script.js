...
var app = new Vue({
    ...
    data: {
        ...
        dog_models_list: [
            {title: "Rottweiler", model: "a_c_rottweiler", img: "https://docs.fivem.net//peds/a_c_rottweiler.webp"},
            {title: "Husky", model: "a_c_husky", img: "https://docs.fivem.net//peds/a_c_husky.webp"},
            {title: "Shephard", model: "a_c_shepherd", img: "https://docs.fivem.net//peds/a_c_shepherd.webp"},
            {title: "Retriver", model: "a_c_retriever", img: "https://docs.fivem.net//peds/a_c_retriever.webp"},
            {title: "Pug", model: "a_c_pug", img: "https://docs.fivem.net//peds/a_c_pug.webp"},
            {title: "Poodle", model: "a_c_poodle", img: "https://docs.fivem.net//peds/a_c_poodle.webp"},
            {title: "Westy", model: "a_c_westy", img: "https://docs.fivem.net//peds/a_c_westy.webp"},

            {title: "Cat", model: "a_c_cat_01", img: "https://docs.fivem.net//peds/a_c_cat_01.webp"},
            {title: "Cow", model: "a_c_cow", img: "https://docs.fivem.net//peds/a_c_cow.webp"},
            {title: "Horse", model: "a_c_deer", img: "https://docs.fivem.net//peds/a_c_deer.webp"},
