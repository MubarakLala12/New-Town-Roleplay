...
$(".btnQuestion").click(function () {
	$.post('http://virus-drivingschool/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://virus-drivingschool/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://virus-drivingschool/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
