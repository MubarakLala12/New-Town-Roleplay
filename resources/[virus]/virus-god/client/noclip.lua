...
RegisterNetEvent('virus-god:client:toggleNoclip')
AddEventHandler('virus-god:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            CTRPFW.Functions.Notify("Current speed: ".. speeds[travelSpeed])
