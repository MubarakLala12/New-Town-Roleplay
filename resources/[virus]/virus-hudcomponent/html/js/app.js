...
(() => {
    ...
    HTRPHud.Close = function() {

    };

    HTRPHud.Show = function(data) {
        if(data.type == "cash") {
    ...
    HTRPHud.ToggleSeatbelt = function(data) {
        if (data.seatbelt) {
    ...
    HTRPHud.ToggleHarness = function(data) {
        if (data.toggle) {
    ...
    HTRPHud.UpdateHud = function(data) {
        var Show = "block";
        if (data.show) {
            Show = "none";
    ...
    HTRPHud.UpdateProximity = function(data) {
        if (data.prox == 1) {
    ...
    HTRPHud.SetTalkingState = function(data) {
        if (!data.IsTalking) {
    ...
    HTRPHud.UpdateCompass = function(data) {
    ...
    HTRPHud.UpdateMeters = function(data) {
    ...
    window.onload = function(e) {
        window.addEventListener('message', function(event) {
            switch(event.data.action) {
                case "open":
                    HTRPHud.Open(event.data);
                    break;
                case "close":
                    HTRPHud.Close();
                    break;
                case "update":
                    HTRPHud.Update(event.data);
                    break;
                case "show":
                    HTRPHud.Show(event.data);
                    break;
                case "hudtick":
                    HTRPHud.UpdateHud(event.data);
                    break;
                case "car":
                    HTRPHud.CarHud(event.data);
                    break;
                case "seatbelt":
                    HTRPHud.ToggleSeatbelt(event.data);
                    break;
                case "harness":
                    HTRPHud.ToggleHarness(event.data);
                    break;
                case "proximity":
                    HTRPHud.UpdateProximity(event.data);
                    break;
                case "talking":
                    HTRPHud.SetTalkingState(event.data);
                    break;
                case "UpdateCompass":
                    HTRPHud.UpdateCompass(event.data);
                    break;
                case "UpdateDrivingMeters":
                    HTRPHud.UpdateMeters(event.data);
                    break;
